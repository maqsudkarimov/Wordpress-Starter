...
class WeDevs_Settings_API {
    ...
    function callback_file( $args ) {
        ...
        $html  .= '<input type="button" class="button wpsa-browse" value="' . $label . '" /><img style="max-width:300px;border: 1px solid #ddd;margin-top: 5px;margin-left: 1px;display:block" src="' . $value . '" class="wpsa-image attachment-thumb">';
        $html  .= $this->get_field_description( $args );
            ...
            jQuery(document).ready(function($) {
                ...
                $('.wpsa-browse').on('click', function (event) {
                    ...
                    file_frame.on('select', function () {
                        ...
                        self.next('.wpsa-image').attr('src', attachment.sizes.thumbnail.url);//attachment.sizes.medium.url
